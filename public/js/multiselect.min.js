...
!function (t) {
    ...
    var e = function (t) {
        ...
        return e.prototype = {
            init: function () {
                var e = this;
                e.undoStack = [], e.redoStack = [], (e.$left.find("optgroup").length || e.$right.find("optgroup").length) && (e.callbacks.sort = !1), e.options.keepRenderingSort && (e.skipInitSort = !0, e.callbacks.sort !== !1 && (e.callbacks.sort = function (e, o) {
                ...
                e.options.search && e.options.search.$left && e.options.search.$left.on("keyup", function (o) {
                    ...
                    o.preventDefault(), e.doNotSortRight = !0;
                    var n = e.$right.find(":selected:not(span):not(.hidden)");
                    n.first().prev().before(n), t(this).blur()
                }), e.actions.$moveDown.on("click", function (o) {
                    o.preventDefault(), e.doNotSortRight = !0;
                    var n = e.$right.find(":selected:not(span):not(.hidden)");
                    n.last().next().after(n), t(this).blur()
                })
            }, moveToRight: function (e, o, n, i) {
                var r = this;
                return "function" == typeof r.callbacks.moveToRight ? r.callbacks.moveToRight(r, e, o, n, i) : !("function" == typeof r.callbacks.beforeMoveToRight && !n && !r.callbacks.beforeMoveToRight(r.$left, r.$right, e)) && (e.each(function (e, o) {
                        var n = t(o);
                        if (r.options.ignoreDisabled && n.is(":disabled"))return !0;
                        if (n.parent().is("optgroup")) {
                            var i = n.parent(), l = r.$right.find('optgroup[label="' + i.prop("label") + '"]');
                            l.length || (l = i.clone(), l.children().remove()), n = l.append(n), i.removeIfEmpty()
                        }
                        r.$right.move(n)
                    }), i || (r.undoStack.push(["right", e]), r.redoStack = []), "function" != typeof r.callbacks.sort || n || r.doNotSortRight || r.$right.mSort(r.callbacks.sort), "function" != typeof r.callbacks.afterMoveToRight || n || r.callbacks.afterMoveToRight(r.$left, r.$right, e), r)
            }, moveToLeft: function (e, o, n, i) {
                var r = this;
                return "function" == typeof r.callbacks.moveToLeft ? r.callbacks.moveToLeft(r, e, o, n, i) : !("function" == typeof r.callbacks.beforeMoveToLeft && !n && !r.callbacks.beforeMoveToLeft(r.$left, r.$right, e)) && (e.each(function (e, o) {
                        var n = t(o);
                        if (n.is("optgroup") || n.parent().is("optgroup")) {
                            var i = n.is("optgroup") ? n : n.parent(), l = r.$left.find('optgroup[label="' + i.prop("label") + '"]');
                            l.length || (l = i.clone(), l.children().remove()), n = l.append(n.is("optgroup") ? n.children() : n), i.removeIfEmpty()
                        }
                        r.$left.move(n)
                    }), i || (r.undoStack.push(["left", e]), r.redoStack = []), "function" != typeof r.callbacks.sort || n || r.$left.mSort(r.callbacks.sort), "function" != typeof r.callbacks.afterMoveToLeft || n || r.callbacks.afterMoveToLeft(r.$left, r.$right, e), r)
            }, undo: function (t) {
    ...
    t.fn.multiselect = function (o) {
        return this.each(function () {
            var n = t(this), i = n.data("crlcu.multiselect"), r = t.extend({}, t.multiselect.defaults, n.data(), "object" == typeof o && o);
        ...
        return this.removeClass("hidden").show(), n && this.each(function (e, o) {
            t(o).parent().is("span") && t(o).parent().replaceWith(o), t(o).show()
        }), this
    }, t.fn.mHide = function () {
        return this.addClass("hidden").hide(), n && this.each(function (e, o) {

...
class RPossibleresult {
	...
	*/
	...
	/**
    * Delete data from the table[r_possibleresult] in the order below
    * array ('id','scheme_id','scheme_sub_group','response')
    * is mapped into
    * array ($id,$scheme_id,$scheme_sub_group,$response)
    * @return int number of deleted rows
    */
    public function delete_prepared_records($id,$scheme_id,$scheme_sub_group,$response, $printSQL = false) {
    	$columns = array('id','scheme_id','scheme_sub_group','response');
    	$records = array($id,$scheme_id,$scheme_sub_group,$response);
    	return $this->delete_record_from_r_possibleresult( $columns, $records, $printSQL );
    }

...
* RepProviderrounds
*  
* Low level class for manipulating the data in the table rep_providerrounds
*
...
class RepProviderrounds {
	...
	*/
	...
	/**
	* private class variable $_periodDescription
	*/
	private $_periodDescription;
	
	/**
	* returns the value of $periodDescription
	*
	* @return object(int|string) periodDescription
	*/
	public function _getPeriodDescription() {
		return $this->_periodDescription;
	}
	
	/**
	* sets the value of $_periodDescription
	*
	* @param periodDescription
	*/
	public function _setPeriodDescription($periodDescription) {
		$this->_periodDescription = $periodDescription;
	}
	/**
	* sets the value of $_periodDescription
	*
	...
	*/
	public function setPeriodDescription($periodDescription) {
		$this->_setPeriodDescription($periodDescription);
		return $this;
	}
	...
	*/
	...
	/**
	* private class variable $_enrolledLabs
	*/
	private $_enrolledLabs;
	
	/**
	* returns the value of $enrolledLabs
	*
	* @return object(int|string) enrolledLabs
	*/
	public function _getEnrolledLabs() {
		return $this->_enrolledLabs;
	}
	
	/**
	* sets the value of $_enrolledLabs
	*
	* @param enrolledLabs
	*/
	public function _setEnrolledLabs($enrolledLabs) {
		$this->_enrolledLabs = $enrolledLabs;
	}
	/**
	* sets the value of $_enrolledLabs
	*
	...
	* @return object ( this class)
	*/
	public function setEnrolledLabs($enrolledLabs) {
		$this->_setEnrolledLabs($enrolledLabs);
		return $this;
	}
	...
	*/
     ...
     * based on the value of $ID,$PeriodDescription,$ProviderID,$EnrolledLabs,$CreatedBy,$CreatedDate passed to the function
     *
     * @param $ID,$PeriodDescription,$ProviderID,$EnrolledLabs,$CreatedBy,$CreatedDate
     * @return object (ID)| null
     */
	public function getID($ID,$PeriodDescription,$ProviderID,$EnrolledLabs,$CreatedBy,$CreatedDate) {
		...
		$ID_ = $this->query_from_rep_providerrounds ( $columns, $records );
		return sizeof($ID_)>0 ? $ID_ [0] ['ID'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of PeriodDescription 
     * based on the value of $ID passed to the function
     *
     * @param $ID
     * @return object (PeriodDescription)| null
     */
	public function getPeriodDescription($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$PeriodDescription_ = $this->query_from_rep_providerrounds ( $columns, $records );
		return sizeof($PeriodDescription_)>0 ? $PeriodDescription_ [0] ['PeriodDescription'] : null;
	}
	...
	public function getProviderID($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$ProviderID_ = $this->query_from_rep_providerrounds ( $columns, $records );
		return sizeof($ProviderID_)>0 ? $ProviderID_ [0] ['ProviderID'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of EnrolledLabs 
     * based on the value of $ID passed to the function
     *
     * @param $ID
     * @return object (EnrolledLabs)| null
     */
	public function getEnrolledLabs($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$EnrolledLabs_ = $this->query_from_rep_providerrounds ( $columns, $records );
		return sizeof($EnrolledLabs_)>0 ? $EnrolledLabs_ [0] ['EnrolledLabs'] : null;
	}
	...
	public function getCreatedBy($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$CreatedBy_ = $this->query_from_rep_providerrounds ( $columns, $records );
	...
	public function getCreatedDate($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$CreatedDate_ = $this->query_from_rep_providerrounds ( $columns, $records );
	...
	*/
	public function insert_prepared_records($ID,$PeriodDescription,$ProviderID,$EnrolledLabs,$CreatedBy,$CreatedDate,$redundancy_check= false, $printSQL = false) {
		$columns = array('ID','PeriodDescription','ProviderID','EnrolledLabs','CreatedBy','CreatedDate');
		$records = array($ID,$PeriodDescription,$ProviderID,$EnrolledLabs,$CreatedBy,$CreatedDate);
		return $this->insert_records_to_rep_providerrounds ( $columns, $records,$redundancy_check, $printSQL );
	}

	/**
    * Delete data from the table[rep_providerrounds] in the order below
    * array ('ID','PeriodDescription','ProviderID','EnrolledLabs','CreatedBy','CreatedDate')
    * is mapped into
    * array ($ID,$PeriodDescription,$ProviderID,$EnrolledLabs,$CreatedBy,$CreatedDate)
    * @return int number of deleted rows
    */
    public function delete_prepared_records($ID,$PeriodDescription,$ProviderID,$EnrolledLabs,$CreatedBy,$CreatedDate, $printSQL = false) {
    	$columns = array('ID','PeriodDescription','ProviderID','EnrolledLabs','CreatedBy','CreatedDate');
    	$records = array($ID,$PeriodDescription,$ProviderID,$EnrolledLabs,$CreatedBy,$CreatedDate);
    	return $this->delete_record_from_rep_providerrounds( $columns, $records, $printSQL );
    }
	...
	* @return string table name -> 'rep_providerrounds' 
	*/
	public static function get_table() {
		return 'rep_providerrounds';
	}
	...
	*/
	...
	/**
     * Used  to calculate the number of times a record exists in the table rep_providerrounds
     * It returns the number of times a record exists exists in the table rep_providerrounds
     * @param array $columns
     * @param array $records
     * @param bool $printSQL
     * @return mixed
	...
	/**
     * Inserts data into the table rep_providerrounds
     * if redundancy check is true, it inserts if the record if it never existed else.
     * if the record exists, it returns the number of times the record exists on the relation
     *
     * @param array $columns
	...
	/**
	 * Deletes all the records that meets the passed criteria from the table rep_providerrounds
	 * @param array $columns
	 * @param array $records
	 * @param bool $printSQL
	 * @return number of deleted rows
	 */
	public function delete_record_from_rep_providerrounds(Array $columns, Array $records, $printSQL = false) {
		return $this->delete_record ( $this->get_table (), $columns, $records, $printSQL );
	}
	
	/**
	 * Updates all the records that meets the passed criteria from the table rep_providerrounds
	 * 
	 * @param array $columns
	 * @param array $records
	 ...
	 */
	public function update_record_in_rep_providerrounds(Array $columns, Array $records, Array $where_columns, Array $where_records, $printSQL = false) {
		return $this->update_record ( $this->get_table (), $columns, $records, $where_columns, $where_records, $printSQL );
	}
	
	/**
	 * Gets an Associative array of the records in the table 'rep_providerrounds' that meets the passed criteria
	 *
	 * @param $distinct
	 * @param array $columns
	 * @param array $records
	 ...
	 */
	public function fetch_assoc_in_rep_providerrounds($distinct, Array $columns, Array $records, $extraSQL="", $printSQL = false) {
	 ...
	 * @return array|mixed associative
	 */
	public function query_from_rep_providerrounds(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
		return $this->query ( $this->get_table (), $columns, $records,$extraSQL,$printSQL );
	}
	
	/**
	 * Gets an Associative array of the records in the table rep_providerrounds that meets the passed distinct criteria
	 * 
	 * @param array $columns
	 * @param array $records
	 * @param string $extraSQL
	 ...
	 * @return array|mixed associative
	 */
	public function query_distinct_from_rep_providerrounds(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
		return $this->query_distinct ( $this->get_table (), $columns, $records,$extraSQL,$printSQL );
	}
	
	/**
	 * Performs a search in the table rep_providerrounds that meets the passed criteria
	 * 
	 * @param array $columns
	 * @param array $records
	 * @param string $extraSQL
	 ...
	 * @return array|mixed associative
	 */
	public function search_in_rep_providerrounds(Array $columns, Array $records,$extraSQL="", $printSQL = false) {
   ...
   * @throws NullabilityException
	...
	/**
     * Gets an Associative array of the records in the table rep_providerrounds that meets the distinct passed criteria
     * @param $table
     * @param array $columns
     * @param array $records
     * @param string $extraSQL
	...
	private function query_distinct($table, Array $columns, Array $records,$extraSQL="",$printSQL = false) {
	 ...
	 /**
     * Performs a search and returns an associative array of the records in the table rep_providerrounds  that meets the passed criteria
     * 
     * @param $table
     * @param array $columns
     * @param array $records

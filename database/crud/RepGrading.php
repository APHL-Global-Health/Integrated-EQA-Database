...
* RepGrading
*  
* Low level class for manipulating the data in the table rep_grading
*
...
class RepGrading {
	...
	*/
	...
	/**
	* private class variable $_gradeDescription
	*/
	private $_gradeDescription;
	
	/**
	* returns the value of $gradeDescription
	*
	* @return object(int|string) gradeDescription
	*/
	public function _getGradeDescription() {
		return $this->_gradeDescription;
	}
	
	/**
	* sets the value of $_gradeDescription
	*
	* @param gradeDescription
	*/
	public function _setGradeDescription($gradeDescription) {
		$this->_gradeDescription = $gradeDescription;
	}
	/**
	* sets the value of $_gradeDescription
	*
	...
	*/
	public function setGradeDescription($gradeDescription) {
		$this->_setGradeDescription($gradeDescription);
		return $this;
	}
	...
	*/
     ...
     * based on the value of $ID,$GradeDescription,$ProgramID,$ProviderID,$CreatedDate,$CreatedBy passed to the function
     *
     * @param $ID,$GradeDescription,$ProgramID,$ProviderID,$CreatedDate,$CreatedBy
     * @return object (ID)| null
     */
	public function getID($ID,$GradeDescription,$ProgramID,$ProviderID,$CreatedDate,$CreatedBy) {
		...
		$ID_ = $this->query_from_rep_grading ( $columns, $records );
		return sizeof($ID_)>0 ? $ID_ [0] ['ID'] : null;
	}
	
	
	/**
     * Performs a database query and returns the value of GradeDescription 
     * based on the value of $ID passed to the function
     *
     * @param $ID
     * @return object (GradeDescription)| null
     */
	public function getGradeDescription($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$GradeDescription_ = $this->query_from_rep_grading ( $columns, $records );
		return sizeof($GradeDescription_)>0 ? $GradeDescription_ [0] ['GradeDescription'] : null;
	}
	...
	public function getProgramID($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$ProgramID_ = $this->query_from_rep_grading ( $columns, $records );
	...
	public function getProviderID($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$ProviderID_ = $this->query_from_rep_grading ( $columns, $records );
	...
	public function getCreatedDate($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$CreatedDate_ = $this->query_from_rep_grading ( $columns, $records );
	...
	public function getCreatedBy($ID) {
		$columns = array ('ID');
		$records = array ($ID);
		$CreatedBy_ = $this->query_from_rep_grading ( $columns, $records );
	...
	*/
	public function insert_prepared_records($ID,$GradeDescription,$ProgramID,$ProviderID,$CreatedDate,$CreatedBy,$redundancy_check= false, $printSQL = false) {
		$columns = array('ID','GradeDescription','ProgramID','ProviderID','CreatedDate','CreatedBy');
		$records = array($ID,$GradeDescription,$ProgramID,$ProviderID,$CreatedDate,$CreatedBy);
		return $this->insert_records_to_rep_grading ( $columns, $records,$redundancy_check, $printSQL );
	}

	/**
    * Delete data from the table[rep_grading] in the order below
    * array ('ID','GradeDescription','ProgramID','ProviderID','CreatedDate','CreatedBy')
    * is mapped into
    * array ($ID,$GradeDescription,$ProgramID,$ProviderID,$CreatedDate,$CreatedBy)
    * @return int number of deleted rows
    */
    public function delete_prepared_records($ID,$GradeDescription,$ProgramID,$ProviderID,$CreatedDate,$CreatedBy, $printSQL = false) {
    	$columns = array('ID','GradeDescription','ProgramID','ProviderID','CreatedDate','CreatedBy');
    	$records = array($ID,$GradeDescription,$ProgramID,$ProviderID,$CreatedDate,$CreatedBy);
    	return $this->delete_record_from_rep_grading( $columns, $records, $printSQL );
    }
	...
	* @return string table name -> 'rep_grading' 
	*/
	...
	*/
	...
	/**
     * Used  to calculate the number of times a record exists in the table rep_grading
     * It returns the number of times a record exists exists in the table rep_grading
     * @param array $columns
     * @param array $records
     * @param bool $printSQL
     * @return mixed
	...
	/**
     * Inserts data into the table rep_grading
     * if redundancy check is true, it inserts if the record if it never existed else.
     * if the record exists, it returns the number of times the record exists on the relation
     *
     * @param array $columns
	...
	/**
	 * Deletes all the records that meets the passed criteria from the table rep_grading
	 * @param array $columns
	 * @param array $records
	 * @param bool $printSQL
	 * @return number of deleted rows
	 */
	public function delete_record_from_rep_grading(Array $columns, Array $records, $printSQL = false) {
		return $this->delete_record ( $this->get_table (), $columns, $records, $printSQL );
	}
	
	/**
	 * Updates all the records that meets the passed criteria from the table rep_grading
	 * 
	 * @param array $columns
	 * @param array $records
	 ...
	 */
	public function update_record_in_rep_grading(Array $columns, Array $records, Array $where_columns, Array $where_records, $printSQL = false) {
		return $this->update_record ( $this->get_table (), $columns, $records, $where_columns, $where_records, $printSQL );
	}
	
	/**
	 * Gets an Associative array of the records in the table 'rep_grading' that meets the passed criteria
	 *
	 * @param $distinct
	 * @param array $columns
	 * @param array $records
	 ...
	 */
	public function fetch_assoc_in_rep_grading($distinct, Array $columns, Array $records, $extraSQL="", $printSQL = false) {
	 ...
	 * @return array|mixed associative
	 */
	public function query_from_rep_grading(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
		return $this->query ( $this->get_table (), $columns, $records,$extraSQL,$printSQL );
	}
	
	/**
	 * Gets an Associative array of the records in the table rep_grading that meets the passed distinct criteria
	 * 
	 * @param array $columns
	 * @param array $records
	 * @param string $extraSQL
	 ...
	 * @return array|mixed associative
	 */
	public function query_distinct_from_rep_grading(Array $columns, Array $records,$extraSQL="",  $printSQL = false) {
		return $this->query_distinct ( $this->get_table (), $columns, $records,$extraSQL,$printSQL );
	}
	
	/**
	 * Performs a search in the table rep_grading that meets the passed criteria
	 * 
	 * @param array $columns
	 * @param array $records
	 * @param string $extraSQL
	 ...
	 * @return array|mixed associative
	 */
	public function search_in_rep_grading(Array $columns, Array $records,$extraSQL="", $printSQL = false) {
   ...
   * @throws NullabilityException
	...
	/**
     * Gets an Associative array of the records in the table rep_grading that meets the distinct passed criteria
     * @param $table
     * @param array $columns
     * @param array $records
     * @param string $extraSQL
	...
	private function query_distinct($table, Array $columns, Array $records,$extraSQL="",$printSQL = false) {
	 ...
	 /**
     * Performs a search and returns an associative array of the records in the table rep_grading  that meets the passed criteria
     * 
     * @param $table
     * @param array $columns
     * @param array $records

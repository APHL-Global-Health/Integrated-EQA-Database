...
class Application_Model_DbTable_Samples extends Zend_Db_Table_Abstract
{
    protected $_name = 'rep_providersamples';
    ...
    public function getAllSamples($parameters)
    {
        ...
        $aColumns = array('SampleCode','ProviderID','ProgramID', 'PeriodID', 'LabID');
        ...
        foreach ($rResult as $aRow) {
            ...
            $row[] = $aRow['PeriodID'];
            $row[] = $aRow['LabID'];
            $row[] = '<a href="/admin/samples/edit/id/' . $aRow['ID'] . '" class="btn btn-warning btn-xs" style="margin-right: 2px;"><i class="icon-pencil"></i> Edit</a>';
            $output['aaData'][] = $row;
        }

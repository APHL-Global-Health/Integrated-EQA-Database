...
class Application_Model_DbTable_Failreasons extends Zend_Db_Table_Abstract
{
    protected $_name = 'rep_failreasons';
    protected $_primary = 'ID';
    
    public function getAllFailreasons($parameters)
    {
        ...
        $aColumns = array('ReasonDescription','ProviderID','ProgramID');

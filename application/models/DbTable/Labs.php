...
class Application_Model_DbTable_Labs extends Zend_Db_Table_Abstract
{
    protected $_name = 'rep_labs';
    protected $_primary = 'LabID';
    
    public function getAllLabs($parameters)
    {
        ...
        $aColumns = array('LabName','Address','Telephone', 'ContactName', 'ContactEmail', 'ContactTelephone','Status');
    ...
    public function getLabDetails($adminId){
        return $this->fetchRow($this->select()->where("LabID = ? ",$adminId));
    }
	...
	$authNameSpace = new Zend_Session_Namespace('administrators');
        ...
        return $this->update($data,"LabID=".$params['LabID']);
    }
}

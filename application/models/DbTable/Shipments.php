...
class Application_Model_DbTable_Shipments extends Zend_Db_Table_Abstract {
    ...
    public function returnEnrolledLabs($shipmentId) {
...
error_log(json_encode($parameters));
    ...
    public function getShipmentAllDetails($parameters) {
        ...
        $aColumns = array('s.shipment_id', 'year(shipment_date)', 'DATE_FORMAT(shipment_date,"%d-%b-%Y")', 'scheme_name', 'shipment_code', 'unique_identifier', 'institute_name', 'DATE_FORMAT(spm.shipment_test_report_date,"%d-%b-%Y")');

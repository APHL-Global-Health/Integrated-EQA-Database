...
class Application_Model_DbTable_Resultcodes extends Zend_Db_Table_Abstract
{
    protected $_name = 'rep_providerresultcodes';
    protected $_primary = 'ID';
    
    public function getAllResultcodes($parameters)
    {
        ...
        $aColumns = array('ID','ResultCode','ProviderID');
        ...
        foreach ($rResult as $aRow) {
            ...
            $row[] = $aRow['ResultCode'];
            $row[] = $aRow['ProviderID'];
            $row[] = '<a href="/admin/resultcodes/edit/id/' . $aRow['ID'] . '" class="btn btn-warning btn-xs" style="margin-right: 2px;"><i class="icon-pencil"></i> Edit</a>';
            $output['aaData'][] = $row;
        }
